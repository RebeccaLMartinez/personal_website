...
format:
  html:
    theme: darkly   <!-- Using a dark theme for the HTML output -->
    css: styles.css <!-- Custom CSS file to style the page -->
---
...
<div class="cat-button" onclick="toggleContent('chester-profile', this)">
  ![Chester Odin](/media/chester.jpeg){.cat-thumb}
...
<div id="chester-profile" class="cat-details" style="display:none;">
  ...
  <br><br>
  ![Chester playing](/media/chester.jpeg){style="max-width:300px; border-radius:12px; border:3px solid #4FA78D;"}
</div>

<!-- Button for Leo's profile -->
<div class="cat-button" onclick="toggleContent('leo-profile', this)">
  ![Leonel Vili](/media/leo.jpeg){.cat-thumb}
...
<div id="leo-profile" class="cat-details" style="display:none;">
  ...
  <br><br>
  ![Leo with hair-tie](/media/leo.jpeg){style="max-width:300px; border-radius:12px; border:3px solid #4FA78D;"}
</div>
